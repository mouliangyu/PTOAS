...
python3 ptodsl/tests/ptodsl_jit_diagnostics.py
python3 ptodsl/tests/ptodsl_subkernel_diagnostics.py
python3 ptodsl/tests/ptodsl_flash_attention_demo_compile.py
python3 ptodsl/tests/ptodsl_ptoas_frontend_verify.py
