...
#include "PTO/Transforms/VPTOLLVMEmitterLegacy.h"
...
LogicalResult
translateVPTOModuleToLLVMTextLegacy(ModuleOp module, llvm::raw_ostream &os,
                                    const VPTOEmissionOptions &options,
                                    llvm::raw_ostream &diagOS) {
  llvm::LLVMContext llvmContext;
  auto llvmModule =
...
LogicalResult
translateVPTOModuleToLLVMBitcodeLegacy(ModuleOp module,
                                       llvm::raw_ostream &os,
                                       const VPTOEmissionOptions &options,
                                       llvm::raw_ostream &diagOS) {
  llvm::LLVMContext llvmContext;
