...
- v0.4: Add cube MAT ISA (`vmatmul` and GM/L1/L0 movement ops); inline `docs/isa/16-cube-matmul.md`
- v0.3: Refresh VPTO ISA specification
...
| 16 | [Cube Matrix Multiply (MAT)](#isa-16-cube-matmul) | GM↔L1 cube staging, L0A/L0B loads, L0C matmul, GM writeback | 5 | `pto.copy_gm_to_cbuf_align_v2`, `pto.load_cbuf_to_ca`, `pto.load_cbuf_to_cb`, `pto.vmatmul`, `pto.copy_matrix_cc_to_gm` |
...
| GM→L1 (cube staging) | 16 | `pto.copy_gm_to_cbuf_align_v2` |
...
| Cube matmul (L0A×L0B→L0C) | 16 | `pto.vmatmul` |
