...
CUBE_CASES="${CUBE_CASES:-mad_mx mad_f16f16f32 mad_f32f32f32 mad_bf16bf16f32 cube-bridge-matmul cube-bridge-store-nz2dn-nchw cube-bridge-store-nz2dn-ncdhw cube-load-frac-layouts}"
