...
void LaunchVmi_swiglu_mx_quant_f16_e4m3_64x512_kernel(
    uint16_t *src, uint8_t *out, uint8_t *scale, void *stream);

int main() {
  constexpr size_t kRows = 64;
  constexpr size_t kInputCols = 512;
  constexpr size_t kOutCols = 256;
  ...
  LaunchVmi_swiglu_mx_quant_f16_e4m3_64x512_kernel(
