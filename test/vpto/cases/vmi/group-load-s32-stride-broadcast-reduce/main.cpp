...
void LaunchVmi_group_load_s32_stride_broadcast_reduce_kernel(float *src,
                                                             float *dst,
                                                             void *stream);

int main() {
  constexpr size_t kRows = 8;
  constexpr size_t kRowStride = 40;
  constexpr size_t kInputElems = kRows * kRowStride;
  ...
  LaunchVmi_group_load_s32_stride_broadcast_reduce_kernel(srcDevice, dstDevice,
                                                          stream);
