...
extern "C" __global__ AICORE void trowexpandmul_kernel_2d(__gm__ float* v1, __gm__ float* v2, __gm__ float* v3);
#else
extern "C" __global__ AICORE void trowexpandmul_kernel_2d(__gm__ float* v1, __gm__ float* v2, __gm__ float* v3);
#endif

void LaunchTrowexpandmul_kernel_2d(float *v1, float *v2, float *v3, void *stream) {
#if defined(__CCE_AICORE__)
    trowexpandmul_kernel_2d<<<1, nullptr, stream>>>((__gm__ float*)v1, (__gm__ float*)v2, (__gm__ float*)v3);
#else
    trowexpandmul_kernel_2d<<<1, nullptr, stream>>>((__gm__ float*)v1, (__gm__ float*)v2, (__gm__ float*)v3);
#endif
}
