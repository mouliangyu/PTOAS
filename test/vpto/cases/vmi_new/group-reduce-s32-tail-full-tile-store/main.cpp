...
void LaunchVmi_group_reduce_s32_tail_full_tile_store_kernel(float *src,
                                                            float *dst,
                                                            void *stream);

int main() {
  constexpr size_t kPhysicalRows = 8;
  constexpr size_t kGroupSize = 32;
  constexpr size_t kInputElems = kPhysicalRows * kGroupSize;
  constexpr size_t kOutputElems = kPhysicalRows;
  ...
  LaunchVmi_group_reduce_s32_tail_full_tile_store_kernel(srcDevice, dstDevice,
                                                         stream);
