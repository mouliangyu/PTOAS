...
vmi_masked_load_group_tail_s32_reduce_store_kernel(__gm__ float *src, __gm__ float *copy,
                                         __gm__ float *sum);

void LaunchVmi_masked_load_group_tail_s32_reduce_store_kernel(float *src, float *copy,
                                                    float *sum, void *stream) {
  vmi_masked_load_group_tail_s32_reduce_store_kernel<<<1, nullptr, stream>>>(
