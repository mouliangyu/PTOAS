...
void LaunchVmi_simdvf_per_block_cast_to_fp8_kernel(uint16_t *src, float *scale,
                                                   uint8_t *out8,
                                                   void *stream);
...
int main() {
  ...
  constexpr size_t kScaleRows = 4;
  constexpr size_t kScaleCols = 8;
  constexpr size_t kScaleElems = kScaleRows * kScaleCols;
  ...
  LaunchVmi_simdvf_per_block_cast_to_fp8_kernel(srcDevice, scaleDevice,
                                                outDevice, stream);
