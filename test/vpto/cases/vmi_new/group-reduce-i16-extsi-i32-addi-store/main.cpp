...
void LaunchVmi_group_reduce_i16_extsi_i32_addi_store_kernel(int16_t *src,
                                                            int32_t *dst,
                                                            void *stream);

int main() {
  constexpr size_t kInputElems = 128;
  ...
  ACL_CHECK(aclrtMemcpy(dstDevice, dstBytes, dstHost, dstBytes,
                        ACL_MEMCPY_HOST_TO_DEVICE));
  LaunchVmi_group_reduce_i16_extsi_i32_addi_store_kernel(srcDevice, dstDevice,
                                                         stream);
