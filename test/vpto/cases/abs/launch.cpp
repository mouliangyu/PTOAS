...
extern "C" __global__ AICORE void abs_kernel_2d(__gm__ float* v1, __gm__ float* v2);
#else
extern "C" __global__ AICORE void abs_kernel_2d(__gm__ float* v1, __gm__ float* v2);
#endif

void LaunchAbs_kernel_2d(float *v1, float *v2, void *stream) {
#if defined(__CCE_AICORE__)
    abs_kernel_2d<<<1, nullptr, stream>>>((__gm__ float*)v1, (__gm__ float*)v2);
#else
    abs_kernel_2d<<<1, nullptr, stream>>>((__gm__ float*)v1, (__gm__ float*)v2);
#endif
}
