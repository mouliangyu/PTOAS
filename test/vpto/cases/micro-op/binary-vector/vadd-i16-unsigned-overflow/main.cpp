...
void LaunchVadd_i16_unsigned_overflow_kernel(uint16_t *v1, uint16_t *v2, uint16_t *v3,
                                             void *stream);
...
int main() {
  ...
  ACL_CHECK(aclrtMemcpy(v3Device, fileSize_v3, v3Host, fileSize_v3,
                        ACL_MEMCPY_HOST_TO_DEVICE));
  LaunchVadd_i16_unsigned_overflow_kernel(v1Device, v2Device, v3Device, stream);
