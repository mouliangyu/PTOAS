...
// family: reduction
// target_ops: pto.vcgmin
// scenarios: group-reduction, result-placement
...
extern "C" __global__ AICORE void vcgmin_tie_kernel_2d(__gm__ float *v1,
                                                 __gm__ float *v2);

void LaunchVcgminTie_kernel_2d(float *v1, float *v2, void *stream) {
  vcgmin_tie_kernel_2d<<<1, nullptr, stream>>>((__gm__ float *)v1, (__gm__ float *)v2);
}
