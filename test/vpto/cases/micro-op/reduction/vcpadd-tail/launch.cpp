...
extern "C" __global__ AICORE void vcpadd_tail_kernel_2d(__gm__ float *v1,
                                                 __gm__ float *v2);

void LaunchVcpaddTail_kernel_2d(float *v1, float *v2, void *stream) {
  vcpadd_tail_kernel_2d<<<1, nullptr, stream>>>((__gm__ float *)v1, (__gm__ float *)v2);
}
