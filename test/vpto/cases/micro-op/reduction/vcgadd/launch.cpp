...
extern "C" __global__ AICORE void vcgadd_kernel_2d(__gm__ float *v1,
                                                 __gm__ float *v2);

void LaunchVcgadd_kernel_2d(float *v1, float *v2, void *stream) {
  vcgadd_kernel_2d<<<1, nullptr, stream>>>((__gm__ float *)v1, (__gm__ float *)v2);
}
