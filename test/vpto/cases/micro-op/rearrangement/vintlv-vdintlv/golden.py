...
# NOTE: paired vintlv+vdintlv roundtrip should recover the original input.
# coding=utf-8
...
def main() -> None:
    parser = argparse.ArgumentParser(
        description="Generate numpy-based inputs/golden for VPTO micro-op vintlv+vdintlv validation."
    )
