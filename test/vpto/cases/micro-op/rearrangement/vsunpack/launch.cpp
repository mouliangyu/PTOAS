...
// target_ops: pto.vsunpack
// scenarios: pack-unpack, sign-extend
...
extern "C" __global__ AICORE void vsunpack_kernel_2d(__gm__ float *v1,
                                                     __gm__ float *v2);

void LaunchVsunpack_kernel_2d(float *v1, float *v2, void *stream) {
  vsunpack_kernel_2d<<<1, nullptr, stream>>>((__gm__ float *)v1, (__gm__ float *)v2);
}
