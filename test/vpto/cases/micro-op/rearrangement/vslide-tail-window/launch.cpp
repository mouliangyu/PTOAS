...
extern "C" __global__ AICORE void vslide_tail_kernel_2d(__gm__ float *v1,
                                                        __gm__ float *v2);

void LaunchVslide_tail_kernel_2d(float *v1, float *v2, void *stream) {
  vslide_tail_kernel_2d<<<1, nullptr, stream>>>((__gm__ float *)v1,
                                                (__gm__ float *)v2);
}
