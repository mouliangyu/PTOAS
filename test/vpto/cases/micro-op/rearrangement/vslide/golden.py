...
# NOTE: per-64-lane slide window with src1 == src0 and amt == 1.
# coding=utf-8
...
def generate(output_dir: Path, seed: int) -> None:
    ...
    for base in range(0, flat.size, 64):
        ...
        golden[base : base + 64] = np.roll(chunk, 1)
...
def main() -> None:
    parser = argparse.ArgumentParser(
        description="Generate numpy-based inputs/golden for VPTO micro-op vslide validation."
    )
