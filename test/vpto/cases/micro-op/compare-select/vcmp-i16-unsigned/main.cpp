...
int main() {
  ...
  size_t fileSize_v1 = elemCount_v1 * sizeof(unsigned short);
  size_t elemCount_v2 = 128;
  size_t fileSize_v2 = elemCount_v2 * sizeof(unsigned short);
  size_t elemCount_v3 = 32;
  size_t fileSize_v3 = elemCount_v3 * sizeof(unsigned char);
  unsigned short *v1Host = nullptr;
  unsigned short *v1Device = nullptr;
  unsigned short *v2Host = nullptr;
  unsigned short *v2Device = nullptr;
