...
void LaunchVselr_u8_kernel_2d(uint8_t *v1, uint8_t *v2, uint8_t *v3,
                              void *stream);

int main() {
  size_t elemCount_v1 = 1024;
  size_t fileSize_v1 = elemCount_v1 * sizeof(uint8_t);
  size_t elemCount_v2 = 1024;
  size_t fileSize_v2 = elemCount_v2 * sizeof(uint8_t);
  size_t elemCount_v3 = 1024;
  size_t fileSize_v3 = elemCount_v3 * sizeof(uint8_t);
  ...
  LaunchVselr_u8_kernel_2d(v1Device, v2Device, v3Device, stream);
