...
extern "C" __global__ AICORE void vldas_vldus_state_chain_kernel_2d(__gm__ float *v1,
                                                 __gm__ float *v2);

void LaunchVldasVldusStateChain_kernel_2d(float *v1, float *v2, void *stream) {
  vldas_vldus_state_chain_kernel_2d<<<1, nullptr, stream>>>((__gm__ float *)v1, (__gm__ float *)v2);
}
