...
void LaunchVscatter_out_of_order_index_kernel_2d(float *v1, int *v2, float *v3,
                                                 void *stream);
...
int main() {
    ...
    LaunchVscatter_out_of_order_index_kernel_2d(v1Device, v2Device, v3Device, stream);
