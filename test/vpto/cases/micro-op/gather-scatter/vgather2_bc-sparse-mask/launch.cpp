...
// scenarios: core-f32, masked-gather, load-effect-validation, no-alias
...
extern "C" __global__ AICORE void vgather2_bc_sparse_mask_kernel_2d(
    __gm__ float *v1, __gm__ int *v2, __gm__ float *v3);

void LaunchVgather2_bc_sparse_mask_kernel_2d(float *v1, int *v2, float *v3,
                                             void *stream) {
  vgather2_bc_sparse_mask_kernel_2d<<<1, nullptr, stream>>>(
      (__gm__ float *)v1, (__gm__ int *)v2, (__gm__ float *)v3);
}
