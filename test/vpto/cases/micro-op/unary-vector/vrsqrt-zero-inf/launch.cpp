...
// family: unary-vector
// target_ops: pto.vrsqrt
// scenarios: core-f32, exceptional-values
...
extern "C" __global__ AICORE void vrsqrt_zero_inf_kernel_2d(__gm__ float *v1,
                                                 __gm__ float *v2);

void LaunchVrsqrtZeroInf_kernel_2d(float *v1, float *v2, void *stream) {
  vrsqrt_zero_inf_kernel_2d<<<1, nullptr, stream>>>((__gm__ float *)v1, (__gm__ float *)v2);
}
