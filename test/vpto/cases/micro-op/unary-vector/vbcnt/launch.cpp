...
extern "C" __global__ AICORE void vbcnt_kernel_2d(__gm__ float *v1,
                                                 __gm__ float *v2);

void LaunchVbcnt_kernel_2d(float *v1, float *v2, void *stream) {
  vbcnt_kernel_2d<<<1, nullptr, stream>>>((__gm__ float *)v1, (__gm__ float *)v2);
}
