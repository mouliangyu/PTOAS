...
extern "C" __global__ AICORE void vrec_zero_inf_kernel_2d(__gm__ float *v1,
                                                 __gm__ float *v2);

void LaunchVrecZeroInf_kernel_2d(float *v1, float *v2, void *stream) {
  vrec_zero_inf_kernel_2d<<<1, nullptr, stream>>>((__gm__ float *)v1, (__gm__ float *)v2);
}
