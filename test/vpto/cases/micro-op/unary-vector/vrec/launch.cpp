...
extern "C" __global__ AICORE void vrec_kernel_2d(__gm__ float *v1,
                                                 __gm__ float *v2);

void LaunchVrec_kernel_2d(float *v1, float *v2, void *stream) {
  vrec_kernel_2d<<<1, nullptr, stream>>>((__gm__ float *)v1, (__gm__ float *)v2);
}
