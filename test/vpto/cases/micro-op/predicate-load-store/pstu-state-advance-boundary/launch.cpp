...
void LaunchPstu_state_advance_kernel_2d(float *v1, float *v2, uint16_t *v3,
                                        void *stream) {
  pstu_state_advance_kernel_2d<<<1, nullptr, stream>>>(
      (__gm__ float *)v1, (__gm__ float *)v2, (__gm__ uint16_t *)v3);
}
