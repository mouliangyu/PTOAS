...
# target_ops: pto.pnot
# scenarios: predicate-transform, logical-not
# coding=utf-8
...
SEED = 19
OUTPUT_WORDS = 32
GOLDEN_PREFIX_WORDS = np.array([0, 286261248, 286331153, 286331153, 286331153, 286331153, 286331153, 286331153], dtype=np.uint32)
