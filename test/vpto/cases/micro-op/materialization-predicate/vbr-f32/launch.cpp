...
extern "C" __global__ AICORE void vbr_f32_kernel_2d(__gm__ float *v1);

void LaunchVbr_f32_kernel_2d(float *v1, void *stream) {
  vbr_f32_kernel_2d<<<1, nullptr, stream>>>((__gm__ float *)v1);
}
