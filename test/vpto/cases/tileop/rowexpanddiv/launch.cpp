...
void LaunchVec_trowexpanddiv_kernel_2d(float *v1, float *v2, float *v3, void *stream) {
#if defined(__CCE_AICORE__)
    vec_trowexpanddiv_kernel_2d<<<1, nullptr, stream>>>((__gm__ float*)v1, (__gm__ float*)v2, (__gm__ float*)v3);
#else
    vec_trowexpanddiv_kernel_2d<<<1, nullptr, stream>>>((__gm__ float*)v1, (__gm__ float*)v2, (__gm__ float*)v3);
#endif
}
