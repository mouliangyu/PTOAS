...
extern "C" __global__ AICORE void rowmax_kernel_2d(__gm__ float* v1, __gm__ float* v2);

void LaunchRowmax_kernel_2d(float *v1, float *v2, void *stream) {
#if defined(__CCE_AICORE__)
    rowmax_kernel_2d<<<1, nullptr, stream>>>((__gm__ float*)v1, (__gm__ float*)v2);
#else
    rowmax_kernel_2d<<<1, nullptr, stream>>>((__gm__ float*)v1, (__gm__ float*)v2);
#endif
}
