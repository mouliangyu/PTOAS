  ...
  func.func @two_vecscope_loops() attributes {pto.version_selection_applied} {
    ...
    pto.vecscope {
      scf.for %i = %c0 to %c1 step %c1 {
        ...
        %max = pto.vmax %lhs_vec, %rhs_vec, %mask : !pto.vreg<64xf32>, !pto.vreg<64xf32>, !pto.mask<b32> -> !pto.vreg<64xf32>
        %dst = pto.castptr %c8320_i64 : i64 -> !pto.ptr<f32, ub>
        pto.vsts %max, %dst[%i], %mask : !pto.vreg<64xf32>, !pto.ptr<f32, ub>, !pto.mask<b32>
      }
    }
    ...
    pto.vecscope {
      scf.for %j = %c0 to %c1 step %c1 {
        ...
        %sum = pto.vadd %lhs_vec, %rhs_vec, %mask : !pto.vreg<64xf32>, !pto.vreg<64xf32>, !pto.mask<b32> -> !pto.vreg<64xf32>
        %dst = pto.castptr %c64_i64 : i64 -> !pto.ptr<f32, ub>
        pto.vsts %sum, %dst[%j], %mask : !pto.vreg<64xf32>, !pto.ptr<f32, ub>, !pto.mask<b32>
      }
    }
    return
  }
