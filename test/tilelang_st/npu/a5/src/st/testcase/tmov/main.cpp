...
// Host driver for TileLang tmov ST — case-table driven.
...
struct TestCase {
    const char *name;
    void (*launch)(void *src, void *dst, void *stream);
...
static const TestCase kCases[] = {
    {"f32_64x64",    (void(*)(void*,void*,void*))LaunchTMOV_f32_64x64,    64,   64,   64,   64,   sizeof(float)},
    {"f32_32x32",    (void(*)(void*,void*,void*))LaunchTMOV_f32_32x32,    32,   32,   32,   32,   sizeof(float)},
    {"f32_128x128",  (void(*)(void*,void*,void*))LaunchTMOV_f32_128x128,  128,  128,  128,  128,  sizeof(float)},
    {"f32_128x32",   (void(*)(void*,void*,void*))LaunchTMOV_f32_128x32,   128,  32,   128,  32,   sizeof(float)},
    {"f32_128x64",   (void(*)(void*,void*,void*))LaunchTMOV_f32_128x64,   128,  64,   128,  64,   sizeof(float)},
    {"f16_64x64",    (void(*)(void*,void*,void*))LaunchTMOV_f16_64x64,    64,   64,   64,   64,   sizeof(uint16_t)},
    {"f16_32x32",    (void(*)(void*,void*,void*))LaunchTMOV_f16_32x32,    32,   32,   32,   32,   sizeof(uint16_t)},
...
int main(int argc, char *argv[]) {
    // Optional case filter: ./tmov [case_name]
