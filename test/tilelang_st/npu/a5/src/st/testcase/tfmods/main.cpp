...
// Host driver for TileLang tfmods ST — case-table driven.
// tfmods: dst = src - trunc(src/scalar) * scalar (floating-point modulo).
...
void LaunchTFMODS_f16_63x64(uint16_t *src, uint16_t *dst, void *stream);
...
static const TestCase kCases[] = {
    {"f32_32x64",   (void (*)(void*,void*,void*))LaunchTFMODS_f32_32x64,   32,  64,  32,  64,  sizeof(float)},
    {"f16_63x64",   (void (*)(void*,void*,void*))LaunchTFMODS_f16_63x64,   63,  64,  63,  64,  sizeof(uint16_t)},
    {"f32_7x448",   (void (*)(void*,void*,void*))LaunchTFMODS_f32_7x448,   7,   448, 7,   448, sizeof(float)},
    {"f32_256x16",  (void (*)(void*,void*,void*))LaunchTFMODS_f32_256x16,  256, 16,  256, 16,  sizeof(float)},
};
...
int main(int argc, char *argv[]) {
    // Optional case filter: ./tfmods [case_name]
