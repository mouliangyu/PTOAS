...
// Host driver for TileLang trems ST — case-table driven.
// trems: dst = src - trunc(src/scalar) * scalar (integer remainder via vdiv).
...
int main(int argc, char *argv[]) {
    // Optional case filter: ./trems [case_name]
