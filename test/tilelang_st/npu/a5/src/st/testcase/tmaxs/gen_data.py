...
# Scalar value used for element-wise maximum (matches the scalar passed in launch.cpp)
SCALAR = 5.0
...
for case in CASES:
    ...
    golden[:vr, :vc] = np.maximum(input1[:vr, :vc], scalar_val).astype(dtype, copy=False)
