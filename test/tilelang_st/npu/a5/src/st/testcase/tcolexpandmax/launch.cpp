...
extern "C" __global__ AICORE void TCOLEXPANDMAX_fp16_4_256_1_256(__gm__ aclFloat16 *src0, __gm__ aclFloat16 *src1, __gm__ aclFloat16 *dst);

void LaunchTCOLEXPANDMAX_fp16_4_256_1_256(aclFloat16 *src0, aclFloat16 *src1, aclFloat16 *dst, void *stream) {
    TCOLEXPANDMAX_fp16_4_256_1_256<<<1, nullptr, stream>>>((__gm__ aclFloat16 *)src0, (__gm__ aclFloat16 *)src1, (__gm__ aclFloat16 *)dst);
}

// Case 4: fp16_10_64_1_64
extern "C" __global__ AICORE void TCOLEXPANDMAX_fp16_10_64_1_64(__gm__ aclFloat16 *src0, __gm__ aclFloat16 *src1, __gm__ aclFloat16 *dst);

void LaunchTCOLEXPANDMAX_fp16_10_64_1_64(aclFloat16 *src0, aclFloat16 *src1, aclFloat16 *dst, void *stream) {
    TCOLEXPANDMAX_fp16_10_64_1_64<<<1, nullptr, stream>>>((__gm__ aclFloat16 *)src0, (__gm__ aclFloat16 *)src1, (__gm__ aclFloat16 *)dst);
}
