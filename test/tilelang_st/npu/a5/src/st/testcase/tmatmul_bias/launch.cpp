...
extern "C" __global__ AICORE void TMATMUL_BIAS_f16_bias_bf16_112x127x80(__gm__ uint16_t *a, __gm__ uint16_t *b, __gm__ float *bias, __gm__ float *c);
void LaunchTMATMUL_BIAS_f16_bias_bf16_112x127x80(void *a, void *b, void *bias, void *c, void *stream) {
    TMATMUL_BIAS_f16_bias_bf16_112x127x80<<<1, nullptr, stream>>>((__gm__ uint16_t *)a, (__gm__ uint16_t *)b, (__gm__ float *)bias, (__gm__ float *)c);
}

// ---- case_bias_4: bf16 x bf16 -> f32, bias bf16, 80x112x63 ----
extern "C" __global__ AICORE void TMATMUL_BIAS_bf16_bias_bf16_80x112x63(__gm__ uint16_t *a, __gm__ uint16_t *b, __gm__ float *bias, __gm__ float *c);
void LaunchTMATMUL_BIAS_bf16_bias_bf16_80x112x63(void *a, void *b, void *bias, void *c, void *stream) {
    TMATMUL_BIAS_bf16_bias_bf16_80x112x63<<<1, nullptr, stream>>>((__gm__ uint16_t *)a, (__gm__ uint16_t *)b, (__gm__ float *)bias, (__gm__ float *)c);
}
