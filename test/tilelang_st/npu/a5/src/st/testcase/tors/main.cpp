...
// Host driver for TileLang tors ST — case-table driven.
// tors: dst = src | scalar (single input + scalar, bitwise OR).
...
static const TestCase kCases[] = {
    {"i32_32x64",   (void (*)(void*,void*,void*))LaunchTORS_i32_32x64,   32,  64,  32,  64,  sizeof(int32_t)},
...
int main(int argc, char *argv[]) {
    // Optional case filter: ./tors [case_name]
