...
// Host driver for TileLang tmuls ST — case-table driven.
// tmuls: dst = src * scalar (single input + scalar).
...
static const TestCase kCases[] = {
    {"f32_32x64",   (void (*)(void*,void*,void*))LaunchTMULS_f32_32x64,   32,  64,  32,  64,  sizeof(float)},
    {"f16_63x64",   (void (*)(void*,void*,void*))LaunchTMULS_f16_63x64,   63,  64,  63,  64,  sizeof(uint16_t)},
    {"i32_31x128",  (void (*)(void*,void*,void*))LaunchTMULS_i32_31x128,  31,  128, 31,  128, sizeof(int32_t)},
...
int main(int argc, char *argv[]) {
    // Optional case filter: ./tmuls [case_name]
