...
// Host driver for TileLang trowexpandexpdif ST — row-wise broadcast exponential difference.
// Supports f32, f16
...
static const TestCase kCases[] = {
    // f32 cases
    {"f32_32x64", (LaunchFn)LaunchTROWEXPANDEXPDIF_f32_32x64, 32, 64, 32, 8, 32, 64, 32, 64, sizeof(float)},
    {"f32_16x32", (LaunchFn)LaunchTROWEXPANDEXPDIF_f32_16x32, 16, 32, 16, 8, 16, 32, 16, 32, sizeof(float)},
    {"f32_16x128_noeq", (LaunchFn)LaunchTROWEXPANDEXPDIF_f32_16x128_noeq, 16, 128, 16, 8, 16, 128, 16, 128, sizeof(float)},
    // f16 cases
    {"f16_16x32", LaunchTROWEXPANDEXPDIF_f16_16x32, 16, 32, 16, 16, 16, 32, 16, 32, sizeof(uint16_t)},
    {"f16_48x64", LaunchTROWEXPANDEXPDIF_f16_48x64, 48, 64, 48, 16, 48, 64, 48, 64, sizeof(uint16_t)},
};
