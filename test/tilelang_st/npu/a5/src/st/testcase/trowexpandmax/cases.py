...
"""Single source of truth for trowexpandmax ST test cases.

trowexpandmax: row-wise broadcast maximum.
- src1Col=1: only first column of src1 is valid, broadcast to dstCols
- src1Col>1: launchTRowExpandMax2 with different semantics (TBD)
...
CASES = [
    # launchTRowExpandMax<float, 16, 32, 16, 1, true>
    {
        "name": "f32_16x32",
        "dtype": np.float32,
        "src0_shape": (16, 32),
    ...
    # launchTRowExpandMax<float, 56, 128, 56, 1, true>
    {
        "name": "f32_56x128",
        "dtype": np.float32,
        "src0_shape": (56, 128),
    ...
    # launchTRowExpandMax<aclFloat16, 48, 64, 48, 1, true>
    {
        "name": "f16_48x64",
        "dtype": np.float16,
        "src0_shape": (48, 64),
    ...
    # launchTRowExpandMax<aclFloat16, 16, 128, 16, 1, true>
    {
        "name": "f16_16x128",
        "dtype": np.float16,
        "src0_shape": (16, 128),
    ...
    # launchTRowExpandMax<aclFloat16, 32, 64, 32, 1, false>
    {
        "name": "f16_32x64_noeq",
        "dtype": np.float16,
    ...
    # launchTRowExpandMax<int32_t, 16, 32, 16, 1, true>
    {
        "name": "i32_16x32",
        "dtype": np.int32,
        "src0_shape": (16, 32),
    ...
    # launchTRowExpandMax<int16_t, 16, 64, 16, 1, true>
    {
        "name": "i16_16x64",
        "dtype": np.int16,
        "src0_shape": (16, 64),
