...
// Host driver for TileLang tcolexpanddiv ST
// Test cases match PTO-ISA: /home/zhoushaofan/code/pto-isa/tests/npu/a5/src/st/testcase/tcolexpanddiv/
...
static int RunCase(const TestCase &tc, int deviceId, aclrtStream stream) {
    ...
    std::printf("[INFO] === case: %s (src0=%zux%zu, src1=%zux%zu -> dst=%zux%zu, valid=%zux%zu) ===\n",
                tc.name, tc.src0Rows, tc.src0Cols, tc.src1Rows, tc.src1Cols, 
