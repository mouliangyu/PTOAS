...
extern "C" __global__ AICORE void TCOLEXPANDDIV_fp32_32_64_1_64(__gm__ float *src0, __gm__ float *src1, __gm__ float *dst);

void LaunchTCOLEXPANDDIV_fp32_32_64_1_64(float *src0, float *src1, float *dst, void *stream) {
    TCOLEXPANDDIV_fp32_32_64_1_64<<<1, nullptr, stream>>>((__gm__ float *)src0, (__gm__ float *)src1, (__gm__ float *)dst);
}

// Case 2: fp32_8_32_1_32
...
extern "C" __global__ AICORE void TCOLEXPANDDIV_int16_16_64_1_64(__gm__ int16_t *src0, __gm__ int16_t *src1, __gm__ int16_t *dst);

void LaunchTCOLEXPANDDIV_int16_16_64_1_64(int16_t *src0, int16_t *src1, int16_t *dst, void *stream) {
    TCOLEXPANDDIV_int16_16_64_1_64<<<1, nullptr, stream>>>((__gm__ int16_t *)src0, (__gm__ int16_t *)src1, (__gm__ int16_t *)dst);
}

// Case: fp32_40_32_1_32
extern "C" __global__ AICORE void TCOLEXPANDDIV_fp32_40_32_1_32(__gm__ float *src0, __gm__ float *src1, __gm__ float *dst);

void LaunchTCOLEXPANDDIV_fp32_40_32_1_32(float *src0, float *src1, float *dst, void *stream) {
    TCOLEXPANDDIV_fp32_40_32_1_32<<<1, nullptr, stream>>>((__gm__ float *)src0, (__gm__ float *)src1, (__gm__ float *)dst);
}
...
extern "C" __global__ AICORE void TCOLEXPANDDIV_fp32_20_64_1_64(__gm__ float *src0, __gm__ float *src1, __gm__ float *dst);

void LaunchTCOLEXPANDDIV_fp32_20_64_1_64(float *src0, float *src1, float *dst, void *stream) {
    TCOLEXPANDDIV_fp32_20_64_1_64<<<1, nullptr, stream>>>((__gm__ float *)src0, (__gm__ float *)src1, (__gm__ float *)dst);
}
