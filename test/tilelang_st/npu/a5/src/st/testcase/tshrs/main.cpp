...
// Host driver for TileLang tshrs ST — case-table driven.
// tshrs: dst = src >> scalar (single input + scalar, right shift).
...
static const TestCase kCases[] = {
    {"i32_32x64",   (void (*)(void*,void*,void*))LaunchTSHRS_i32_32x64,   32,  64,  32,  64,  sizeof(int32_t)},
...
int main(int argc, char *argv[]) {
    // Optional case filter: ./tshrs [case_name]
