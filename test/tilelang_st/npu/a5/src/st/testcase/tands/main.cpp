...
// Host driver for TileLang tands ST — case-table driven.
// tands: dst = src & scalar (single input + scalar, bitwise AND).
...
static const TestCase kCases[] = {
    {"i32_32x64",   (void (*)(void*,void*,void*))LaunchTANDS_i32_32x64,   32,  64,  32,  64,  sizeof(int32_t)},
...
int main(int argc, char *argv[]) {
    // Optional case filter: ./tands [case_name]
