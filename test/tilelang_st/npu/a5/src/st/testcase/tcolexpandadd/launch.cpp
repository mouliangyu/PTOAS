...
extern "C" __global__ AICORE void TCOLEXPANDADD_fp32_16_128_1_128(__gm__ float *src0, __gm__ float *src1, __gm__ float *dst);

void LaunchTCOLEXPANDADD_fp32_16_128_1_128(float *src0, float *src1, float *dst, void *stream) {
    TCOLEXPANDADD_fp32_16_128_1_128<<<1, nullptr, stream>>>((__gm__ float *)src0, (__gm__ float *)src1, (__gm__ float *)dst);
}

// Case 2: fp32_32_32_1_32
extern "C" __global__ AICORE void TCOLEXPANDADD_fp32_32_32_1_32(__gm__ float *src0, __gm__ float *src1, __gm__ float *dst);

void LaunchTCOLEXPANDADD_fp32_32_32_1_32(float *src0, float *src1, float *dst, void *stream) {
    TCOLEXPANDADD_fp32_32_32_1_32<<<1, nullptr, stream>>>((__gm__ float *)src0, (__gm__ float *)src1, (__gm__ float *)dst);
}
...
void LaunchTCOLEXPANDADD_int32_16_32_1_32(int32_t *src0, int32_t *src1, int32_t *dst, void *stream) {
    TCOLEXPANDADD_int32_16_32_1_32<<<1, nullptr, stream>>>((__gm__ int32_t *)src0, (__gm__ int32_t *)src1, (__gm__ int32_t *)dst);
}

// Case: int16_16_64_1_64
extern "C" __global__ AICORE void TCOLEXPANDADD_int16_16_64_1_64(__gm__ int16_t *src0, __gm__ int16_t *src1, __gm__ int16_t *dst);

void LaunchTCOLEXPANDADD_int16_16_64_1_64(int16_t *src0, int16_t *src1, int16_t *dst, void *stream) {
    TCOLEXPANDADD_int16_16_64_1_64<<<1, nullptr, stream>>>((__gm__ int16_t *)src0, (__gm__ int16_t *)src1, (__gm__ int16_t *)dst);
}
