...
// Host driver for TileLang tmul ST — case-table driven.
...
static const TestCase kCases[] = {
    ...
    {"f32_64x64", LaunchTMUL_f32_64x64, 64, 64, 64, 64, sizeof(float)},
    {"i32_64x64", LaunchTMUL_i32_64x64, 64, 64, 64, 64, sizeof(int32_t)},
    {"i32_32x32", LaunchTMUL_i32_32x32, 32, 32, 32, 32, sizeof(int32_t)},
    {"i16_64x64", LaunchTMUL_i16_64x64, 64, 64, 64, 64, sizeof(int16_t)},
    {"f16_16x16", LaunchTMUL_f16_16x16, 16, 16, 16, 16, sizeof(uint16_t)},
    {"f16_64x64_v61x61", LaunchTMUL_f16_64x64_v61x61, 64, 64, 61, 61, sizeof(uint16_t)},
    {"i32_64x32_v60x30", LaunchTMUL_i32_64x32_v60x30, 64, 32, 60, 30, sizeof(int32_t)},
};
...
int main(int argc, char *argv[]) {
    // Optional case filter: ./tmul [case_name]
