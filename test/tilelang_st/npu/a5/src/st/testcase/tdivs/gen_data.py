...
for case in CASES:
    ...
    precision_mode = case.get("precision_mode", "DEFAULT")
    print(f"[INFO] gen_data: {case['name']} shape={shape} valid_shape={valid_shape} dtype={dtype.__name__} direction={direction} test={test_pattern} precision={precision_mode} scalar={scalar_val}")