...
# Scalar value for division (matches the scalar passed in launch.cpp)
SCALAR = 3.0
...
for case in CASES:
    ...
    # Avoid zero values in src for scalar/src direction (division by zero)
    ...
    print(f"[INFO] gen_data: {case['name']} shape={shape} valid_shape={valid_shape} dtype={dtype.__name__} direction={direction} scalar={SCALAR}")
