...
// Host driver for TileLang txors ST — case-table driven.
// txors: dst = src ^ scalar (bitwise XOR with scalar).
...
static const TestCase kCases[] = {
    {"i32_32x64",   (void (*)(void*,void*,void*))LaunchTXORS_i32_32x64,   32,  64,  32,  64,  sizeof(int32_t)},
...
int main(int argc, char *argv[]) {
    // Optional case filter: ./txors [case_name]
