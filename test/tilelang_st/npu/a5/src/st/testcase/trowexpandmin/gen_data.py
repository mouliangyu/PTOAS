...
"""Generate input and golden data for trowexpandmin ST test cases.

trowexpandmin: dst = min(src0, broadcast(src1))
"""
...
# Inline validation for multi-input format (trowexpandmin uses src0/src1/dst)
