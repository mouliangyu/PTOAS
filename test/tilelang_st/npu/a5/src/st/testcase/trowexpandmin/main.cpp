...
// Host driver for TileLang trowexpandmin ST — row-wise broadcast minimum.
...
static const TestCase kCases[] = {
    // f32 cases
    {"f32_16x32", (LaunchFn)LaunchTROWEXPANDMIN_f32_16x32, 16, 32, 16, 8, 16, 32, 16, 32, sizeof(float)},
    {"f32_56x128", (LaunchFn)LaunchTROWEXPANDMIN_f32_56x128, 56, 128, 56, 8, 56, 128, 56, 128, sizeof(float)},
    // f16 cases
    {"f16_48x64", LaunchTROWEXPANDMIN_f16_48x64, 48, 64, 48, 16, 48, 64, 48, 64, sizeof(uint16_t)},
    {"f16_16x128", LaunchTROWEXPANDMIN_f16_16x128, 16, 128, 16, 16, 16, 128, 16, 128, sizeof(uint16_t)},
    {"f16_32x64_noeq", LaunchTROWEXPANDMIN_f16_32x64_noeq, 32, 64, 32, 16, 32, 64, 32, 64, sizeof(uint16_t)},
    // i32 cases
    {"i32_16x32", LaunchTROWEXPANDMIN_i32_16x32, 16, 32, 16, 8, 16, 32, 16, 32, sizeof(int32_t)},
    // i16 cases
    {"i16_16x64", LaunchTROWEXPANDMIN_i16_16x64, 16, 64, 16, 16, 16, 64, 16, 64, sizeof(int16_t)},
};
