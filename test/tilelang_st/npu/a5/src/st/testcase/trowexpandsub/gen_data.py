...
"""Generate input and golden data for trowexpandsub ST test cases.

trowexpandsub: dst = src0 - broadcast(src1)
"""
...
# Inline validation for multi-input format (trowexpandsub uses src0/src1/dst)
...
for case in CASES:
    ...
    # dst = src0 - src1_scalar (broadcasted)
