...
// CHECK-POS: %[[ABS:.+]] = pto.vabs %[[LOAD]], %[[MASK]] : !pto.vreg<64xf32>, !pto.mask -> !pto.vreg<64xf32>
// CHECK-POS: pto.vsts %[[ABS]], %arg1[%arg2], %[[MASK]] : !pto.vreg<64xf32>, !pto.ptr<f32, ub>, !pto.mask
module {
  func.func @vabs_kernel(%src: !pto.ptr<f32, ub>, %dst: !pto.ptr<f32, ub>, %index: index) {
    ...
    %abs = pto.vabs %tile, %mask : !pto.vreg<64xf32>, !pto.mask -> !pto.vreg<64xf32>
    pto.vsts %abs, %dst[%index], %mask : !pto.vreg<64xf32>, !pto.ptr<f32, ub>, !pto.mask
    return
  }
}
...
module {
  func.func @vabs_shape_mismatch(%src: !pto.ptr<f32, ub>, %dst: !pto.ptr<f32, ub>, %index: index) {
    %mask = pto.pset_b32 "PAT_ALL" : !pto.mask
    %tile = pto.vlds %src[%index] : !pto.ptr<f32, ub> -> !pto.vreg<64xf32>
    %abs = pto.vabs %tile, %mask : !pto.vreg<64xf32>, !pto.mask -> !pto.vreg<128xi16>
    pto.vsts %abs, %dst[%index], %mask : !pto.vreg<128xi16>, !pto.ptr<f32, ub>, !pto.mask
    return
  }
}
