...
def generate(output_dir: Path, seed: int) -> None:
    ...
    # The sample reinterprets row-major storage as col-major, then stores into a
    # DN-strided output view; the flattened destination bytes therefore match
    # the original source buffer.
    golden_v2 = v1.astype(np.float32, copy=False)
