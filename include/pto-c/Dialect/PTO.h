...
MLIR_CAPI_EXPORTED MlirAttribute mlirPTOPrecisionModeAttrGet(MlirContext ctx, int32_t value);
MLIR_CAPI_EXPORTED bool mlirPTOAttrIsAPrecisionModeAttr(MlirAttribute attr);
MLIR_CAPI_EXPORTED int32_t mlirPTOPrecisionModeAttrGetValue(MlirAttribute attr);
